...
public enum StatutFacture {
    BROUILLON,    // Non envoyée (saisie pharmacie/structure)
    SOUMISE_CS,   // Envoyée par le Poste de Santé au Centre de Santé rattaché
    REJETEE_CS,   // Rejetée par le Centre de Santé rattaché
    ENVOYEE,      // Envoyée au Service Régional
    VALIDEE_SR,   // Validée par le SR et transmise au niveau central
    REJETEE_SR,   // Rejetée -> renvoyée à la pharmacie/structure pour correction
